...
if szr_type == 'stimulated' and replace_signal:
    replace_onset = 2
    replace_offset = 3
    raw_sim = vep_prepare.replace_part_of_signal_previous(raw, raw.info, replace_onset, replace_offset,
                                                          ch_names='all')
    replace_onset = 3
    replace_offset = 4
    raw_sim = vep_prepare.replace_part_of_signal_previous(raw_sim, raw.info, replace_onset, replace_offset,
                                                          ch_names='all')
    replace_onset = 4
    replace_offset = 7
    raw = vep_prepare.replace_part_of_signal_previous(raw_sim, raw.info, replace_onset, replace_offset,
                                                      ch_names='all')
    # replace_onset = 0
    # replace_offset = 2.7
    # replace_scale = 0.7
